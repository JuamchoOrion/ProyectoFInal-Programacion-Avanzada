...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ResponseDTO<String>> handleMaxUploadSizeExceeded(MaxUploadSizeExceededException ex) {
        return ResponseEntity
                .badRequest()
                .body(new ResponseDTO<>(
                        true,
                        "El tamaño total de los archivos excede el límite permitido (máximo 50MB por imagen o 500MB por solicitud)."
                ));
    }
